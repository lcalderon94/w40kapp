...
/// La ficha de una unidad: características, habilidades y armas.
///
/// El orden es el de la propia hoja de datos del juego, porque es el que el jugador ya tiene
/// aprendido: primero la línea de características, luego lo que sabe hacer y al final con qué pega.
class PantallaDeUnidad extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final perfiles = Datos.de(context).sheetOf(unidad);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (unidad.keywords.isNotEmpty) ...[
            const _Seccion('Palabras clave'),
            _Palabras(unidad.keywords),
          ],
        ],
      ),
    );
